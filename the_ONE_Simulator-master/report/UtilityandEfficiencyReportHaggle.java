 ...
 * @author User
 */
public class UtilityandEfficiencyReportHaggle extends Report implements MessageListener, ReportHelper {
    ...
    public UtilityandEfficiencyReportHaggle() {
        init();
    }
    ...
    public void newMessage(Message m) {
        //yg baru
        if (m.getId().contains("C") && m.getCreationTime() + WAKTU <= 274883) {
