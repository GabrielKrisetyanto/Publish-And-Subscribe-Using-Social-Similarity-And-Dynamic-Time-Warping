 ...
 * @author User
 */
public class UtilityandEfficiencyReportRealityCoba extends Report implements MessageListener, ReportHelper {
    ...
    public UtilityandEfficiencyReportRealityCoba() {
        init();
    }
    ...
    public void newMessage(Message m) {
        //yg baru
        if (m.getId().contains("C") && m.getCreationTime() + WAKTU <= 2592000) {
