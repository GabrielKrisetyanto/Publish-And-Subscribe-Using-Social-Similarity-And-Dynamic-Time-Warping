 ...
 * @author User
 */
public class SnWDE implements RoutingDecisionEngine {
    ...
    public RoutingDecisionEngine replicate() {
        return new SnWDE(this);
    }

    private SnWDE getOtherSnWDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works "
                + " with other routers of same type";

        return (SnWDE) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }
